...
class Ves_ProductCarousel4_Block_List extends Mage_Catalog_Block_Product_Abstract
{
	...
	public function __construct($attributes = array())
	{
		...
		if(isset($attributes['template']) && $attributes['template']) {
			...
			$template = 'ves/productcarousel4/default_owl.phtml';
    ...
    {
        return array(
           'VES_PRODUCTCAROUSEL4_BLOCK_LIST',
    ...
    public function setDefaultSettings() {
    	$groups = array("ves_productcarousel4", "catalog_source_setting", "carousel_setting", "effect_setting");
    	$tmp_config = array();
    	foreach($groups as $group) {
    		$tmp_array_config = Mage::getStoreConfig('ves_productcarousel4/'.$group); //array
    		if($tmp_array_config) {
