<?php
class Aroma_Subscription_Block_Adminhtml_View_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        return Mage::helper('adminhtml')->__('Edit Shipment Status');
    }
}