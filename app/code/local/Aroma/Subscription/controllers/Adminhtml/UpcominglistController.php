...
class Aroma_Subscription_Adminhtml_UpcominglistController extends Mage_Adminhtml_Controller_Action
{
    ...
    {		
		...
		$this->_addContent($this->getLayout()->createBlock('aroma_subscription/adminhtml_upcominglist'));
        $this->renderLayout();
    }
